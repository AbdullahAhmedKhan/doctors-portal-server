...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.c9mi5.mongodb.net/?retryWrites=true&w=majority`;
...
function sendPaymentConfirmationEmail(booking) {
    ...
    var email = {
        ...
        <div>
            ...
            <a href="https://daisyui.com/components/avatar/">Unsubscribe</a>
        </div>
        `
    };
...
async function run() {
    try {
        ...
        app.get('/available', async (req, res) => {
            ...
            //step 3: for each services, find booking for that services
